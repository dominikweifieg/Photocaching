module PlaysHelper
  ...
  def map_link(source, destination)
    "http://maps.google.com/maps?f=d&amp;source=embed&amp;saddr=#{source.lat},#{source.lng}&amp;daddr=#{destination.lat},#{destination.lng}&amp;hl=en&amp;mra=ls&amp;dirflg=w&amp;ie=UTF8&amp;t=h"
  end
end
